    ...
    <>
      <div className="h-[36rem] bg-white bg-opacity-35 p-5 md:p-10 center-in-flex-col gap-2">
        ...
        <div className="w-full h-1/2 flex flex-row gap-2">
          ...
          <div className="lg:w-1/3 hidden  md:h-56 lg:flex lg:flex-col justify-center items-center gap-3 p-4 bg-[#ffffffc1] border border-[#ffffff09] hover:border-[#3535353a] rounded-md">
          ...
          <div className="lg:w-1/3 w-1/2 h-44 md:h-56 hover-effect-white center-in-flex-col">
            ...
            <div className="size-24 w-36 md:size-36">
              <BarComp />
            </div>
          </div>
        </div>
        <div className="h-1/2 center-in-flex-row w-full gap-2">
          ...
          <div className="md:w-3/5 md:h-56 hover-effect-white center-in-flex-col">
